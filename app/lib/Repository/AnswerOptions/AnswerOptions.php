...
namespace app\lib\AnswerOptions;

use app\lib\AnswerOptions\Model\AnswerOptionsModel;
use app\lib\Main;
use app\lib\Question\Model\FriendsModel;
...
class AnswerOptions extends Main
{
    ...
    public function getAllAnswerAndQuestion(): array
    {
        ...
        foreach ($items as $key => $item) {
            $result[$key] = FriendsModel::setMap($item);
